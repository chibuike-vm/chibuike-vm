...
- **Markup & Styling**: HTML, CSS (Vanilla, Styled-Components, SASS, TailwindCSS)
...
### Freshenger
- **Description**: Freshenger is an innovative e-commerce platform that connects buyers and sellers of fresh products. It offers a seamless interface for sellers to upload and manage their products and for buyers to browse, order, and receive fresh goods delivered directly by the sellers. The sellers pay service fees for completed orders and the payments are approved by the admin if successful.
- **Tech Stack**: JavaScript, TypeScript, React.js, Next.js, Tailwind CSS, Clerk Authentication, Prisma ORM, HTML
